...
2. После reconnect: `ssh admin@192.168.0.50 "echo all270174bae | sudo -S bash ~/nasa/scripts/storage/storage_preflight.sh"`
3. Затем Docker: `ssh admin@192.168.0.50 "echo all270174bae | sudo -S systemctl start docker"`
...
**Beszel Hub: http://193.8.215.130:8091** (login: admin@nasa.local / NASAkfqxI7nk8G)
