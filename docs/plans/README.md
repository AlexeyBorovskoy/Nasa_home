...
| Roadmap Stage 1 / Stage 2 / Stage 3 | частично выполнено; Stage 1 partially recovered после USB-инцидента |
...
6. В текущем состоянии: разобрать Nextcloud data/app state после HTTP 503 и ext4 ошибок.
