...
| Roadmap Stage 1 / Stage 2 / Stage 3 | частично выполнено; Stage 1 сейчас degraded по storage |
...
6. В текущем состоянии: восстановить USB storage и подтвердить `storage_preflight.sh`.
