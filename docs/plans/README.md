...
| Roadmap Stage 1 / Stage 2 / Stage 3 | частично выполнено; Stage 1 recovered после USB-инцидента, hardware watch |
...
6. В текущем состоянии: наблюдать Nextcloud/USB storage после controlled start и готовить reboot/autorecovery test.
